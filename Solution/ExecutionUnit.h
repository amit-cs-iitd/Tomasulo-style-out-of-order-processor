    ...
    BroadcastEvent compute(const RSEntry& e) {
        ...
        switch (e.op) {
            ...
            case OpCode::ADDI:
                ...
                if (overflowsInt32(tmp)) out.has_exception = true;
                else out.value = static_cast<int>(tmp);
                break;
            case OpCode::SUB:
                tmp = static_cast<long long>(e.src1_value) - static_cast<long long>(e.src2_value);
                if (overflowsInt32(tmp)) out.has_exception = true;
            ...
            case OpCode::MUL:
                ...
                break;
            case OpCode::DIV:
                if (e.src2_value == 0) out.has_exception = true;
                else out.value = e.src1_value / e.src2_value;
                break;
            case OpCode::REM:
                if (e.src2_value == 0) out.has_exception = true;
                else out.value = e.src1_value % e.src2_value;
            ...
            case OpCode::BLE: {
                bool taken = false;
                if (e.op == OpCode::BEQ) taken = (e.src1_value == e.src2_value);
                if (e.op == OpCode::BNE) taken = (e.src1_value != e.src2_value);
                if (e.op == OpCode::BLT) taken = (e.src1_value < e.src2_value);
                if (e.op == OpCode::BLE) taken = (e.src1_value <= e.src2_value);
